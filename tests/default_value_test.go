...
func TestDefaultValue(t *testing.T) {
	...
	harumph := Harumph{Email: "hello@github.com/goforkit"}
	...
	var result Harumph
	if err := DB.First(&result, "email = ?", "hello@github.com/goforkit").Error; err != nil {
	...
	harumph2 := Harumph2{ID: 2, Email: "hello2@github.com/goforkit"}
